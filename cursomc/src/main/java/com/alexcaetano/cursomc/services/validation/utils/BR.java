package com.alexcaetano.cursomc.services.validation.utils;
...
public class BR {
     ...
     * @return
     */
    public static boolean isValidCNPJ(String cnpf) {
        if (cnpf == null || !cnpf.matches("\\d{14}") || cnpf.matches(cnpf.charAt(0) + "{14}")) return false;
        return checkEquals(cnpf, 12, WEIGHT_TFN);
    }
}
